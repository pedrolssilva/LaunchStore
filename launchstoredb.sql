...
-- Soft Delete in products table
-- 1. Criar uma coluna na tabela products chamada 'deleted_at'
...
-- 3. Criar uma VIEW onde vamos puxar somente os dados que estao ativos
